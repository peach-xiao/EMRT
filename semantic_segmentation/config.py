...
_C.TRAIN.END_LR = 1e-4  #通过多项式衰减函数，使得学习率值逐步从初始的 learning_rate，衰减到 end_lr
...
# RS settings
_C.MODEL.RSDECODER = CN()
_C.MODEL.RSDECODER.EMBED_DIM = 256
_C.MODEL.RSDECODER.DEPTH = 4
_C.MODEL.RSDECODER.NUM_HEADS = 8
_C.MODEL.RSDECODER.MLP_RATIO = 3.
_C.MODEL.RSDECODER.HID_DIM = 64

# DeformableTransNet settings
_C.MODEL.DEFORMABLE = CN()
_C.MODEL.DEFORMABLE.EMBED_DIM = 256
_C.MODEL.DEFORMABLE.DEPTH = 4
_C.MODEL.DEFORMABLE.NUM_HEADS = 8
_C.MODEL.DEFORMABLE.MLP_RATIO = 3.
_C.MODEL.DEFORMABLE.HID_DIM = 64
...
# misc
_C.SAVE_DIR = "./output"
_C.KEEP_CHECKPOINT_MAX = 1 #默认保留模型的数量
_C.TAG = "default"
_C.SAVE_FREQ_CHECKPOINT = 2000 # freq to save chpt
_C.LOGGING_INFO_FREQ = 100 # freq to logging info
