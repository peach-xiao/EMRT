...
class VIT_MLAHead(nn.Layer):
    ...
    def forward(self, mla_p2, mla_p3, mla_p4, mla_p5):
        up4x_resolution = [4*item for item in mla_p2.shape[2:]]#[32, 32] x 4 --> [128, 128]
        up16x_resolution = [16*item for item in mla_p2.shape[2:]]#[32, 32] x 16 --> [512, 512]

        # print("mla_p2.shape[2:]",mla_p2.shape[2:]) #[32, 32]
        ...
        pred_full = F.interpolate(
            ...
            align_corners=self.align_corners) #[4, 6, 512, 512]
        return pred_full
