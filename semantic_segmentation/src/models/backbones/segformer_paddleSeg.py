...
# this file is copy from paddleseg !
class MLP(nn.Layer):
    """
    Linear Embedding
    """
...
class SegFormer(nn.Layer):
    ...
    def forward(self, x):
        ...
        # print("segformer backbone: ",c1.shape,c2.shape,c3.shape,c4.shape)
        ...
        # print("-c segformer backbone: ", _c1.shape, _c2.shape, _c3.shape, _c4.shape)
        # [8, 768, 64, 64][8, 768, 32, 32][8, 768, 16, 16][8, 768, 8, 8]
