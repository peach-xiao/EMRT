...
def deformable_attention_core_func(value, value_spatial_shapes, sampling_locations, attention_weights):
    """
    Args:
        value (Tensor): [bs, value_length, n_head, c] )  --> [8, 5376, 8, 32]
        value_spatial_shapes (Tensor): [n_levels, 2] --> [3, 2]
        sampling_locations (Tensor): [bs, query_length, n_head, n_levels, n_points, 2] --> [8, 5376, 8, 3, 4, 2]
        attention_weights (Tensor): [bs, query_length, n_head, n_levels, n_points] --> [8, 5376, 8, 3, 4]
